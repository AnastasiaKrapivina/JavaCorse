...
*Ожидаемый результат:* В ответ приходит статус код 200 и ответ {"status": "APPROVED"}.<br>
...
*Ожидаемый результат:* В ответ приходит статус код 200 и ответ {"status": "DECLINED"}.<br>
